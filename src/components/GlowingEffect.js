    ...
    return (
      <>
        ...
        <div
          ...
          className={`pointer-events-none absolute inset-0 rounded-[inherit] opacity-100 transition-opacity w-full h-full ${
            glow ? "opacity-100" : ""
          } ${blur > 0 ? `blur-[${blur}px]` : ""} ${className} ${
            disabled ? "!hidden" : ""
          }`}
        >
          <div
            className="glow rounded-[inherit] absolute inset-0 w-full h-full"
            style={{
